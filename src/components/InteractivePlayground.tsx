...
if __name__ == "__main__":
  ...
  const handleRunEndpoint = () => {
    ...
    setTimeout(() => {
      setIsRunning(false);
      const randomLatency = (Math.random() * 0.4 + 0.1).toFixed(3); // super fast microsecond response!
        ...
        if (!passengerName || passengerName.trim().length < 2) {
          setTerminalOutput({
            ...
            data: {
              ...
              fields: {
                passenger_name: "Value must be at least 2 characters long"
              }
            }
          });
          ...
          setTerminalOutput({
            ...
            data: {
              ...
              fields: {
                seats: "Value must be less than or equal to 4"
              }
            }
          });
          ...
          setTerminalOutput({
            ...
            data: {
              ...
              message: "Value violates range constraint",
              fields: {
                seats: "Value must be greater than or equal to 1"
              }
            }
          });
        } else {
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="font-display font-bold text-3xl sm:text-4xl text-white tracking-tight leading-tight">
            Want to learn more about MicroJet?
          </h2>
          ...
          {steps.map((step) => (
            <button
              ...
              onClick={() => {
                ...
                // Sync active sandbox endpoint with selection
                if (step.endpoint) {
              ...
              id={`playground-step-${step.id}`}
            >
              <div className={`font-mono text-[10px] mb-1 ${activeStep === step.id ? "text-blue-600" : "text-blue-400"}`}>STEP 0{step.id}</div>
              {step.label}
            </button>
          ))}
        </div>
        ...
        <div className="mt-8 max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          {/* Step description and code editor */}
          ...
          <div className="lg:col-span-5 rounded-xl bg-[#0f1423] border border-slate-800/80 p-6 backdrop-blur-sm flex flex-col justify-between relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 radial-glow rounded-full pointer-events-none filter blur-xl opacity-20" />
            ...
            <div>
              ...
              {/* Endpoint selection tabs inside simulator */}
            ...
            <div className="mt-6 pt-5 border-t border-slate-800/60">
              ...
              <button
                ...
                disabled={isRunning}
                className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg text-xs sm:text-sm font-semibold text-slate-950 bg-white hover:bg-slate-100 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] active:scale-98 transition-all duration-200 disabled:opacity-50 cursor-pointer"
                id="sandbox-run-btn"
              >
                {isRunning ? (
              ...
              {/* Terminal Simulator response output console */}
              {terminalOutput && (
                <div className="mt-4 rounded-xl bg-slate-950 border border-slate-800 p-4 font-mono text-left text-xs animate-fade-in" id="sandbox-output-console">
